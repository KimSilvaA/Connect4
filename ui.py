...
# # =========== Main Game Functions =========== # # 
    def on_execute(self):
            ...
            beta = math.inf
            pygame.init()
            width = self.column_count * self.token_size + 200  # Add space at right for AI solver
...
# # =========== Drawing Functions =========== # # 
    def draw_board(self, screen):
        ...
        #         # -------- DRAW HELP BUTTON --------
        # help_button_x = self.column_count * self.token_size + 20
        # help_button_y = 100
        # help_button_width = 160
        # help_button_height = 50
        # self.help_button_rect = pygame.Rect(help_button_x, help_button_y, help_button_width, help_button_height)
        
        # pygame.draw.rect(screen, (200, 200, 200), self.help_button_rect)  # Light gray
        # font = pygame.font.SysFont(None, 36)
        # text = font.render('Help', True, (0, 0, 0))
        # screen.blit(text, (help_button_x + 40, help_button_y + 10))
